...
import com.mediocre.Paclass.Companion.MAIN_ID
import com.mediocre.databinding.ActivityWeeeeBinding
...
class Weeee : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWeeeeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWeeeeBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "ambergold.xyz/go.php?to=2&"
