...
import com.mediocre.Paclass.Companion.AF_DEV_KEY
import com.mediocre.Paclass.Companion.C1
import com.mediocre.Paclass.Companion.CH
import com.mediocre.Paclass.Companion.D1
import com.mediocre.Paclass.Companion.linkAppsCheckPart1
import com.mediocre.Paclass.Companion.linkAppsCheckPart2
import com.mediocre.databinding.ActivityMainBinding
...
//            finish()
    ...
    private fun toTestGrounds() {
        Intent(this, Fill::class.java)
            .also { startActivity(it) }
        finish()
    }

    private fun skipMe() {
        Intent(this, WolGame::class.java)
            .also { startActivity(it) }
        finish()
    }
